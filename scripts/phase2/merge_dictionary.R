# scripts/phase2/merge_dictionary.R
# Reproducible step 2 of dictionary maintenance:
# append completed rows from scripts/phase2/lfo_codes_TODO.csv into the
# dictionary scripts/phase2/lfo_codes.csv, while:
...
# After merging, re-run:  Rscript scripts/phase2/classify_lfo.R
#
# Run:  Rscript scripts/phase2/merge_dictionary.R

options(oscn.autorun.suppress = TRUE)
suppressPackageStartupMessages({ library(dplyr); library(readr) })

DICT_PATH <- "scripts/phase2/lfo_codes.csv"
