# scripts/pilot/phase2/sample_counties.R
...
source("scripts/pilot/phase2/fetch_details.R")   # run_details(), detail fetch infra
source("scripts/pilot/phase1/config.R")          # CHUNK_ROOT, PRE_END, PROJECT_ROOT
