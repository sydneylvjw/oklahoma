# scripts/pilot/phase2/parse_details.R
...
#
# Run from project root:  Rscript scripts/pilot/phase2/parse_details.R
# Parallel (optional):    R -e 'source("scripts/pilot/phase2/parse_details.R"); library(furrr); plan(multisession); run_parse(parallel=TRUE)'
