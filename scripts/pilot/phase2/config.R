...
source("scripts/pilot/phase1/config.R")   # USER_AGENT, throttle consts, CHUNK_ROOT, PROJECT_ROOT
source("scripts/pilot/phase1/http.R")     # oscn_get(), is_challenge()
