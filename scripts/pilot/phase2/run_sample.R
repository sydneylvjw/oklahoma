# scripts/pilot/phase2/run_sample.R
...
#
# Run:  caffeinate -i Rscript scripts/pilot/phase2/run_sample.R
#
...
SAMPLE_SEED  <- 20231101L   # HB 2259 effective date, used as the seed
...
source("scripts/pilot/phase2/sample_counties.R")   # frame / draw / fetch / summary
source("scripts/pilot/phase2/parse_details.R")     # run_parse()
source("scripts/pilot/phase2/classify_lfo.R")      # run_classify()
