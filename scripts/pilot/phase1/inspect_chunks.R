# scripts/pilot/phase1/inspect_chunks.R
# Read-only profiling of the scraped parquet chunks, to plan cleaning.
# Writes nothing. Run from project root:  Rscript scripts/pilot/phase1/inspect_chunks.R
...
source("scripts/pilot/phase1/config.R")   # CHUNK_ROOT
