...
# HB 2259 took effect 2023-11-01 (approved 2023-05-15). 90 calendar days each side.
# NOTE: a related 2022 bill (HB 3925) amended the same ability-to-pay statute and
# was repealed by HB 2259 -- consider whether it confounds the pre-period baseline.
PRE_START  <- as.Date("2023-08-03")
PRE_END    <- as.Date("2023-10-31")
POST_START <- as.Date("2023-11-01")
POST_END   <- as.Date("2024-01-29")
