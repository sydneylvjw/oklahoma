...
``` r
# Load the library if you haven't already:
# library(ojodb)
...
#> 10 public document        
#> 11 public event           
#> 12 public exception_log   
#> 13 public issue           
#> 14 public marital_status  
#> 15 public migrations      
#> 16 public minute          
#> 17 public party           
#> 18 public person_record   
#> 19 public process_log     
...
It looks like `charge_data` includes 169,063 rows. In other words, our data shows that there were 169,063 total **charges** filed in Oklahoma and Tulsa county misdemeanor cases from 2016-2022.

On the other hand, it looks like there are 62,205 unique combinations of `district` and `case_number` (and an equal number of rows in our new summary dataframe, `case_summary`). In other words, our data shows 62,205 total misdemeanor **cases** filed in Oklahoma and Tulsa county from 2016-2022.
...
It seems there's an average of 2.72 counts per misdemeanor case in this dataset. Neat!
...
Again, let's stop and check to make sure the result looks as we expect it to.
                                                                                                                        ...
                                                                                                                        #>    district case_number  count_as_filed          drug_charge
                                                                                                                        #>    <chr>    <chr>        <chr>                   <lgl>      
                                                                                                                        #>  1 OKLAHOMA CM-2019-3729 ABDOM, DOMESTIC ASSAUL… FALSE      
                                                                                                                        #>  2 OKLAHOMA CM-2016-174  FFP, OBTAINING MONEY O… FALSE      
                                                                                                                        #>  3 TULSA    CM-2018-2120 DI5, TRANSPORTING OPEN… FALSE      
                                                                                                                        #>  4 TULSA    CM-2016-2639 WE6, TRANSPORTING LOAD… FALSE      
                                                                                                                        #>  5 TULSA    CM-2018-5596 OBS, OBSTRUCTING AN OF… FALSE      
                                                                                                                        #>  6 TULSA    CM-2022-3716 LMFR, LARCENY OF MERCH… FALSE      
                                                                                                                        #>  7 OKLAHOMA CM-2021-3261 OBS, OBSTRUCTING AN OF… FALSE      
                                                                                                                        #>  8 OKLAHOMA CM-2018-2871 OWN, MAKING A FALSE DE… FALSE      
                                                                                                                        #>  9 OKLAHOMA CM-2022-3214 DI5, TRANSPORTING AN O… FALSE      
                                                                                                                        #> 10 OKLAHOMA CM-2017-396  FR5, FAILURE TO CARRY … FALSE      
                                                                                                                        #> 11 OKLAHOMA CM-2019-2013 DU9, POSSESSION OF A C… TRUE       
                                                                                                                        #> 12 TULSA    CM-2016-5534 DI2DM, DUI DRUGS (MUNI… TRUE       
                                                                                                                        #> 13 OKLAHOMA CM-2022-1459 DR3, UNLAWFUL POSSESSI… TRUE       
                                                                                                                        #> 14 OKLAHOMA CM-2019-1679 DU9II, POSSESSION OF A… TRUE       
                                                                                                                        #> 15 OKLAHOMA CM-2021-1077 DR3, UNLAWFUL POSSESSI… TRUE       
                                                                                                                        #> 16 OKLAHOMA CM-2019-1648 DU9, POSSESSION OF A C… TRUE       
                                                                                                                        #> 17 TULSA    CM-2018-95   DR3, POSSESSION OF DRU… TRUE       
                                                                                                                        #> 18 TULSA    CM-2018-2695 DR3, POSSESSION OF DRU… TRUE       
                                                                                                                        #> 19 OKLAHOMA CM-2022-2759 DR3, UNLAWFUL POSSESSI… TRUE       
                                                                                                                        #> 20 TULSA    CM-2018-2544 DR3MV, POSSESSION OF D… TRUE
                                                                                                                        ```
...
#>    district case_number  date_filed list_all_charges        
#>    <chr>    <chr>        <date>     <chr>                   
#>  1 TULSA    CM-2016-3206 2016-06-23 OBS, OBSTRUCTING AN OFF…
#>  2 OKLAHOMA CM-2020-1346 2020-05-19 OBS, OBSTRUCTING AN OFF…
#>  3 TULSA    CM-2021-1960 2021-06-02 TLCIFM, TRESPASS ON RAI…
#>  4 TULSA    CM-2016-3210 2016-06-23 OBS, OBSTRUCTING AN OFF…
#>  5 OKLAHOMA CM-2019-2666 2019-08-13 FR5, FAILURE TO CARRY V…
#>  6 OKLAHOMA CM-2021-3799 2021-12-28 LMFR, LARCENY OF MERCHA…
#>  7 OKLAHOMA CM-2018-709  2018-02-23 DR1, BEING INTOXICATED …
#>  8 OKLAHOMA CM-2017-2036 2017-06-15 DISDEC, DISTRUBING THE …
#>  9 TULSA    CM-2022-1368 2022-04-25 FFP, FALSE PRETENSE UND…
#> 10 OKLAHOMA CM-2022-1462 2022-05-12 ALC211, SELLING, FURNIS…
#> 11 OKLAHOMA CM-2019-795  2019-03-06 DI1, DRIVING WHILE UNDE…
#> 12 OKLAHOMA CM-2021-2385 2021-08-24 RCSP, RECEIVE, POSSESS …
#> 13 TULSA    CM-2018-1467 2018-04-04 DI2D, DUI DRUGS; DU4II,…
#> 14 OKLAHOMA CM-2020-454  2020-02-27 DU9II, UNLAWFUL POSSESS…
#> 15 OKLAHOMA CM-2022-1249 2022-04-19 DU9, UNLAWFUL POSSESSIO…
#> 16 TULSA    CM-2017-3743 2017-08-17 DU9, POSSESSION OF CONT…
#> 17 OKLAHOMA CM-2019-275  2019-01-22 DU9IV, POSSESSION OF A …
#> 18 TULSA    CM-2019-3339 2019-07-24 DU9II, POSSESSION OF CO…
#> 19 OKLAHOMA CM-2021-616  2021-03-10 DI1, DRIVING UNDER THE …
#> 20 TULSA    CM-2017-421  2017-01-27 DU4, POSSESSION OF CONT…
#> # ℹ 3 more variables: n_total_charges <int>,
#> #   n_drug_charges <int>, drug_charges_present <lgl>
